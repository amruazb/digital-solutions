...
const WhatsAppButton = () => {
  ...
  const phoneNumber = '+971544036701';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Tooltip/Help Text */}
      <div 
        className={`mb-3 mr-2 max-w-xs p-3 bg-white rounded-lg shadow-lg border transition-all duration-300 ${
          isHovered ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-2 pointer-events-none'
        }`}
      >
        <p className="text-sm text-gray-700 font-medium">
          Need help? Chat with us directly!
        </p>
      ...
      <Button
        ...
        className="w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 shadow-lg hover:shadow-xl transition-all duration-300 group relative overflow-hidden"
        size="lg"
      >
